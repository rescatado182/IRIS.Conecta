...
namespace IRIS.UI.Data
{
    public static class SampleData
    {
        ...
        //    {
        //        orders.Add(new Order { Customer = customer, Country = "Sweden", OrderDate = DateTimeOffset.Now.AddDays(-12), GrossValue = rnd.Next(2000, 50000), DiscountPercentage = rnd.Next(10, 50), OrderType = (OrderType)rnd.Next(0, 4) });
        //    }
