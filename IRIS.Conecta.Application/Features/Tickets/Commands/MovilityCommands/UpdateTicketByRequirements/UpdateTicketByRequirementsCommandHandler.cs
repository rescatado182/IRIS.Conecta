...
{
    public class UpdateTicketByRequirementsCommandHandler : IRequestHandler<UpdateTicketByRequirementsCommand, Unit>
    {
        private readonly IMapper mapper;
        private readonly ITicketsRepository ticketsRepository;

        public UpdateTicketByRequirementsCommandHandler(IMapper mapper, ITicketsRepository ticketsRepository)
        {
            this.mapper = mapper;
            this.ticketsRepository = ticketsRepository;
        }
        public async Task<Unit> Handle(UpdateTicketByRequirementsCommand request, CancellationToken cancellationToken)
        {
            ...
            var validator = new UpdateTicketByRequirementsCommandValidator();
